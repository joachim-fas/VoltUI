  ...
  return (
    <div className="space-y-10">
      ...
      <div>
        ...
        <VoltCodeBlock
          code={`// VoltCard.tsx aus /components/volt/ kopieren
<VoltCard variant="default">...</VoltCard>
<VoltCard variant="glass">...</VoltCard>
<VoltCard variant="gradient">...</VoltCard>
// Varianten: default · glass · gradient · elevated · outlined · subtle · interactive`}
      ...
      <div>
        ...
        <VoltCodeBlock
          code={`<VoltBadge variant="default">Lime</VoltBadge>  <VoltBadge variant="solid">Solid</VoltBadge>  <VoltBadge variant="outline">Outline</VoltBadge>
<VoltBadge variant="default" size="sm">Small</VoltBadge>  <VoltBadge variant="default" size="lg">Large</VoltBadge>
<VoltBadge variant="positive" dot dotColor="#1A9E5A">Online</VoltBadge>  <VoltBadge variant="muted" dot>Abwesend</VoltBadge>`}
        />
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          <VoltCodeBlock
          code={`<VoltAlert variant="info" title="Info">Hinweis</VoltAlert>\n<VoltAlert variant="success" title="Erfolg">Gespeichert</VoltAlert>\n<VoltAlert variant="warning" title="Warnung">Achtung</VoltAlert>\n<VoltAlert variant="error" title="Fehler" dismissible>Fehler</VoltAlert>`}
        />
      </div>
      ...
      <div>
        ...
        <VoltCodeBlock
          code={`<VoltAvatar name="Anna Müller" size="md" src="https://..." />
<VoltAvatar name="Max Schmidt" size="lg" online ring />
<VoltAvatarGroup size="md" max={5} avatars={[{ name: "Anna" }, { name: "Max" }]} />`}
        />
      </div>
    </div>
  );
